              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="<c:url value='/resources/img/45.jpg'/>" alt="img">                    
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<c:url value='/resources/img/b2.jpg'/>"alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<c:url value='/resources/img/b1.jpg'/>" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sale Off</span>
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<c:url value='/resources/img/b3.jpg'/>" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<c:url value='/resources/img/b4.jpg'/>"alt="img">                      
                      <div class="aa-prom-content">
                        <span>25% Off</span>
              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#men" data-toggle="tab">Category</a></li>
                    <li><a href="#women" data-toggle="tab">Author</a></li>
                    <li><a href="#sports" data-toggle="tab">Sports</a></li>
                    <li><a href="#electronics" data-toggle="tab">Publisher</a></li>
                  </ul>
                  <!-- Tab panes -->
